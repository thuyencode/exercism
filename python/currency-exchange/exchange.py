"""
Python Exercism: Currency Exchange
"""
...
def exchangeable_value(budget: float, exchange_rate: float, spread: int, denomination: int) -> int:
    ...
    the_exchange_money = int(exchange_money(budget, actual_exchange_rate))
 
    return the_exchange_money - get_leftover_of_bills(the_exchange_money, denomination)
